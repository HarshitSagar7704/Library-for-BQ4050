...
Lib_BQ4050::Lib_BQ4050( char addr ){
...
Lib_BQ4050::DFt dataFlash;
Lib_BQ4050::Regt registers;
...
boolean Lib_BQ4050::getOperationStatus(){
...
boolean Lib_BQ4050::getChargingStatus(){
...
boolean Lib_BQ4050::getGaugingStatus(){
...
boolean Lib_BQ4050::getSafetyStatus(){
...
boolean Lib_BQ4050::getSafetyAlert(){
...
boolean Lib_BQ4050::getXCHGstatus(){
  if( readBlockReg( registers.operationStatus ) ){
...
boolean Lib_BQ4050::getXDSGstatus(){
...
boolean Lib_BQ4050::getPCHGstatus(){
  if( readBlockReg( registers.operationStatus ) ){
    //AND the bit with the byte then shift it right
...
boolean Lib_BQ4050::getCHGstatus(){
  if( readBlockReg( registers.operationStatus ) ){
    //AND the bit with the byte then shift it right
...
boolean Lib_BQ4050::getDSGstatus(){
  if( readBlockReg( registers.operationStatus ) ){
    //AND the bit with the byte then shift it right
...
boolean Lib_BQ4050::getCellBalancingStatus(){
  if( readBlockReg( registers.gaugingStatus ) ){
    //AND the bit with the byte then shift it right
...
boolean Lib_BQ4050::numberOfCells( uint8_t cellNum ){
...
void Lib_BQ4050::FETtoggle(){
  writeCommand( BQ4050addr, FETcontrol );
}

boolean Lib_BQ4050::deviceReset(){
...
boolean Lib_BQ4050::readDataReg( char devAddress, byte regAddress, byte *dataVal, uint8_t arrLen ){
...
boolean Lib_BQ4050::writeDataReg( char devAddress, byte regAddress, byte *dataVal, uint8_t arrLen ){
...
boolean Lib_BQ4050::writeDFByteReg( char devAddress, int16_t regAddress, byte *data, uint8_t arrSize ){
...
boolean Lib_BQ4050::writeCommand( char devAddress, byte regAddress ){
...
boolean Lib_BQ4050::writeMACommand( char devAddress, byte regAddress ){
...
void Lib_BQ4050::CalculateTable_CRC8(){
...
byte Lib_BQ4050::Compute_CRC8(byte *bytes, uint8_t byteLen){
